function make_second_level_covar_matrix(contrast_map, subjects, path_to_contrasts,output_dir,covariates, negative)
...
for ii = 1: contrasts
    ...
    matlabbatch{1}.spm.stats.factorial_design.cov.c = covariates;
    matlabbatch{1}.spm.stats.factorial_design.cov.cname = 'Accuracy';
